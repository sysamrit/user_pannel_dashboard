...
function RCA_UpdateModal({toggleContainer,data,inspectionNo}) {
    ...
    const hrmantraId = window.prompt("Enter your ID:");
      ...
      headers:{"Content-Type":"application/json"}
        ...
        .then((res)=>{
            if(res.status===200){
              axios
                  .put(`${process.env.REACT_APP_BASE_URL2}/rca/update/row/${data.rca_id}`)
                  .then((res) => {
                      console.log(res.data);
                    if(res.data==="DONE"){
                      alert("RCA Approved");
...
// ................Form approval portion previous....................
  ...
  return (
    <>
      <div className="view_container">
        ...
        >
          <button type="button" className="submit_btn" onClick={handleAuthentication}> <FcApproval className="icon_create" />
            Approve
          </button>
...
export default RCA_UpdateModal