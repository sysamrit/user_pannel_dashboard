...
function CreateRCAForm({toggleContainer}) {
  ...
  // Calculate seconds
    ...
    formObj["members"]=members;
    formObj["observations"]=observation;
    formObj["why_analysis"]=whyAnalysis;
    formObj["corrective_action"]=currectiveAction;
    formObj["_3wh_action_plan"]=_3whActionPlan;
            ...
            <div className="sub_div">
              ...
              <div className="form_item">
                ...
                <div className="form_item">
                  ...
                  <input type="text"  id="link_workorder" />
                ...
                <div className="form_item " >
                  ...
                  <button className="member_btn" onClick={addMember}> <RiUserAddLine className="icon" />Add Member</button>
               ...
               <div>
                ...
                <hr className="header-line"/>
                 ...
                 <div className="obs_table">
                  ...
                  <button onClick={addObservation} type="button"> <TbPlaylistAdd className="icon" />Add Observation</button>
                  </div>
                 </div>
              </div>
                {/* Why Why Analysis */}
             ...
             <div className="why_observation">
              {whyAnalysis && whyAnalysis.map((ele,indx)=>{
                  return <WhyObervation update_WhyAnalysis={updateWhyAnalysis}  key={indx} index_no={indx} value={ele}/>
                })}
                <div className="analysis_btn"><button type="button" onClick={addWhyAnalysis}> <TbPlaylistAdd className="icon" />Add Analysis</button></div>
             </div>
              </div>
              ...
              <div className="currective_Action_section">
                ...
                <div className="currective_action">
                 ...
                 return <CurrectiveAction update_Currective_Action={updateCurrectiveAction}  key={index} index_no={index} value={ele} />
                  ...
                  <div className="curr_active_btn"><button type="button" onClick={addCurrectiveAction}> <TbPlaylistAdd className="icon" />Add Corrective Action</button></div>
                </div>
              </div>
              {/* 3WH Action Plan */}
              <div className="threewh_action_plan">
                 ...
                 return <ThreeWhActionPlan update_Action_plan={update3whActionPlan}  key={index} index_no={index} value={ele} inspector_name={inspectors}/>
                  ...
                  <div className="active_plan_btn"><button type="button" onClick={add3whActionPlan}> <TbPlaylistAdd className="icon" />Add Plan</button></div>
            </div>
      </div>
